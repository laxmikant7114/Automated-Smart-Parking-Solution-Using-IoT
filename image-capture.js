...
var takeStill = function () {
    ...
    child.on('exit', function (code, signal) {
        ...
        async function setEndpoint() {
            ...
            var license_number = [];  // Initialize license_number as an empty array

            labels.forEach(function (a, b) {
                //console.log(a.description);
                if (b == 0) {
                    license_number.push(a.description);  // Push the description into the array
                }
            });
            ...
            if (license_number == null) {
                ...
                license_number = license_number.toString(); // Convert to string if not already
            ...
            const licenseNumberString = license_number.join(',');
            fs.writeFileSync('./license_number.txt', licenseNumberString);
            takeStill();
        }
        setEndpoint();
    });
