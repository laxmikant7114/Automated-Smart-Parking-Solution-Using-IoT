    ...
    .then((booking) => {
      if (booking) {
        ...
        exec('python servo_control.py', (error, stdout, stderr) => {
          ...
          console.log("You entered the parking area!");
        });
      } else {
...
const licenseNumbersFilePath = "/var/www/html/app/license_number.txt";  // Assuming "license_number" file is in the root folder
const licenseNumbers = fs.readFileSync(licenseNumbersFilePath, "utf-8").split(',');
